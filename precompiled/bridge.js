...
Object.defineProperty(exports,"__esModule",{value:!0}),__webpack_require__(7169),__webpack_require__(2166),__webpack_require__(7047),__webpack_require__(2850),__webpack_require__(5072),__webpack_require__(1070),__webpack_require__(9224),__webpack_require__(7875),__webpack_require__(1615),__webpack_require__(6438),__webpack_require__(8691),__webpack_require__(1959),__webpack_require__(9025),__webpack_require__(8877),__webpack_require__(4703),__webpack_require__(8023),__webpack_require__(1839),__webpack_require__(2858),__webpack_require__(7719),__webpack_require__(6352),__webpack_require__(1436),__webpack_require__(9517),__webpack_require__(7849),__webpack_require__(8761),__webpack_require__(1492),__webpack_require__(9709),__webpack_require__(4025),__webpack_require__(2438),__webpack_require__(6549)
...
cancel(){this.cancelled=!0,this.emit("cancel")}},ON_CANCEL:"cancel"}},1784:(module,__unused_webpack_exports,__webpack_require__)=>{"use strict"
...
try{module.exports.kuwoapi=__webpack_require__(5477)}catch(e){}},3942:module=>{"use strict"
...
class RequestCancelled extends Error{constructor(url){super(`This request URL has been cancelled: ${url}`),this.name="RequestCancelled"}}module.exports=RequestCancelled},5467:module=>{"use strict"
...
class YtDlpInvalidResponse extends Error{constructor(response){super("The response of yt-dlp is malformed."),this.name="YtDlpInvalidResponse",this.response=response}}module.exports=YtDlpInvalidResponse},201:module=>{"use strict"
class YtDlpNotInstalled extends Error{constructor(){super('You must install "yt-dlp" before using the "ytdlp" source.'),this.name="YtDlpNotInstalled"}}module.exports=YtDlpNotInstalled},5477:module=>{"use strict"
...
const pino=__webpack_require__(8167),destFile=process.env.LOG_FILE
var _LOG_LEVEL
const logger=pino({level:null!==(_LOG_LEVEL=process.env.LOG_LEVEL)&&void 0!==_LOG_LEVEL?_LOG_LEVEL:"info",prettyPrint:"true"!==process.env.JSON_LOG&&{colorize:!0,messageFormat:"[1m[32m({scope})[0m[36m {msg}",ignore:"time,pid,hostname,scope",errorProps:"*"}},destFile&&pino.destination(destFile))
...
return matched?matched.id:Promise.reject()}))})(info))).then(track),track}},2290:(module,__unused_webpack_exports,__webpack_require__)=>{"use strict"
...
return matched?matched.id:Promise.reject()}))})(info))).then(track),track}},1549:(module,__unused_webpack_exports,__webpack_require__)=>{"use strict"
const insure=__webpack_require__(2290),select=__webpack_require__(2822),request=__webpack_require__(5262),{getManagedCacheStorage}=__webpack_require__(9220),format=song=>({id:song.id,name:song.name,album:song.albums&&song.albums[0],artists:song.singers,resources:song.newRateFormats.map((detail=>({formatType:detail.formatType,url:encodeURI(detail.url||detail.androidUrl)})))}),track=resources=>Promise.all(["ZQ","SQ","HQ","PQ"].slice(select.ENABLE_FLAC?0:2).map((format=>((resources,format)=>{const song=resources.find((song=>song.url&&song.formatType===format))
if(song){const playUrl=new URL(song.url)
return playUrl.protocol="http",playUrl.hostname="freetyst.nf.migu.cn",playUrl.href}return!1})(resources,format)))).then((result=>result.find((url=>url))||Promise.reject())).catch((()=>insure().migu.track(resources))),cs=getManagedCacheStorage("provider/migu")
module.exports={check:info=>cs.cache(info,(()=>(info=>{const url="https://pd.musicapp.migu.cn/MIGUM3.0/v1.0/content/search_all.do?&ua=Android_migu&version=5.0.1&pageNo=1&pageSize=10&text="+encodeURIComponent(info.keyword)+'&searchSwitch={"song":1,"album":0,"singer":0,"tagSong":0,"mvSong":0,"songlist":0,"bestShow":1}'
return request("GET",url).then((response=>response.json())).then((jsonBody=>{const list=((jsonBody||{}).songResultData.result||[]).map(format),matched=select(list,info)
return matched?matched.resources:Promise.reject()}))})(info))).then(track),track}},2085:(module,__unused_webpack_exports,__webpack_require__)=>{"use strict"
...
const{getManagedCacheStorage}=__webpack_require__(9220),{logScope}=__webpack_require__(7691),{spawnStdout}=__webpack_require__(7581),YtDlpInvalidResponse=__webpack_require__(2962),YtDlpNotInstalled=__webpack_require__(201),dlArguments=query=>["-f","140","--dump-json",query],logger=logScope("provider/yt-dlp")
...
request.read=read,request.create=create,request.translate=translate,request.configure=configure,module.exports=request},7581:(module,__unused_webpack_exports,__webpack_require__)=>{"use strict"
...
spawn.on("spawn",(()=>{logger.info(`running ${cmd} ${args.join(" ")}`)})),spawn.on("error",(error=>reject(error))),spawn.on("close",(code=>{0!==code?reject(new ProcessExitNotSuccessfully(cmd,code)):(logger.debug(`process ${cmd} exited successfully`),resolve({stdout:stdout.slice(0,stdoutOffset),stderr:stderr.slice(0,stderrOffset)}))})),spawn.stdout.on("data",(stdoutPart=>{stdoutOffset+=stdoutPart.copy(stdout,stdoutOffset)})),spawn.stderr.on("data",(stderrPart=>{logger.warn(`[${cmd}][stderr] ${stderrPart}`),stderrOffset+=stderrPart.copy(stderr,stderrOffset)}))}))}}},160:module=>{"use strict"
...
return"function"==typeof ret&&ret!==cb&&Object.keys(cb).forEach((function(k){ret[k]=cb[k]})),ret}}},5474:(module,__unused_webpack_exports,__webpack_require__)=>{var isCallable=__webpack_require__(987),tryToString=__webpack_require__(5320),$TypeError=TypeError
module.exports=function(argument){if(isCallable(argument))return argument
throw $TypeError(tryToString(argument)+" is not a function")}},943:(module,__unused_webpack_exports,__webpack_require__)=>{var isConstructor=__webpack_require__(6486),tryToString=__webpack_require__(5320),$TypeError=TypeError
module.exports=function(argument){if(isConstructor(argument))return argument
throw $TypeError(tryToString(argument)+" is not a constructor")}},9072:(module,__unused_webpack_exports,__webpack_require__)=>{var isObject=__webpack_require__(2948),$String=String,$TypeError=TypeError
module.exports=function(argument){if(isObject(argument))return argument
throw $TypeError($String(argument)+" is not an object")}},9502:(module,__unused_webpack_exports,__webpack_require__)=>{var toIndexedObject=__webpack_require__(3521),toAbsoluteIndex=__webpack_require__(8876),lengthOfArrayLike=__webpack_require__(5008),createMethod=function(IS_INCLUDES){return function($this,el,fromIndex){var value,O=toIndexedObject($this),length=lengthOfArrayLike(O),index=toAbsoluteIndex(fromIndex,length)
...
module.exports={includes:createMethod(!0),indexOf:createMethod(!1)}},3224:(module,__unused_webpack_exports,__webpack_require__)=>{var uncurryThis=__webpack_require__(335),toString=uncurryThis({}.toString),stringSlice=uncurryThis("".slice)
module.exports=function(it){return stringSlice(toString(it),8,-1)}},157:(module,__unused_webpack_exports,__webpack_require__)=>{var TO_STRING_TAG_SUPPORT=__webpack_require__(5149),isCallable=__webpack_require__(987),classofRaw=__webpack_require__(3224),TO_STRING_TAG=__webpack_require__(4729)("toStringTag"),$Object=Object,CORRECT_ARGUMENTS="Arguments"==classofRaw(function(){return arguments}())
module.exports=TO_STRING_TAG_SUPPORT?classofRaw:function(it){var O,tag,result
return void 0===it?"Undefined":null===it?"Null":"string"==typeof(tag=function(it,key){try{return it[key]}catch(error){}}(O=$Object(it),TO_STRING_TAG))?tag:CORRECT_ARGUMENTS?classofRaw(O):"Object"==(result=classofRaw(O))&&isCallable(O.callee)?"Arguments":result}},4973:(module,__unused_webpack_exports,__webpack_require__)=>{"use strict"
var call=__webpack_require__(4041),aCallable=__webpack_require__(5474),anObject=__webpack_require__(9072)
...
return set}},1105:(module,__unused_webpack_exports,__webpack_require__)=>{"use strict"
var call=__webpack_require__(4041),aCallable=__webpack_require__(5474),anObject=__webpack_require__(9072)
...
return!!allDeleted}},6537:(module,__unused_webpack_exports,__webpack_require__)=>{var hasOwn=__webpack_require__(7902),ownKeys=__webpack_require__(3475),getOwnPropertyDescriptorModule=__webpack_require__(2024),definePropertyModule=__webpack_require__(3271)
...
hasOwn(target,key)||exceptions&&hasOwn(exceptions,key)||defineProperty(target,key,getOwnPropertyDescriptor(source,key))}}},1057:(module,__unused_webpack_exports,__webpack_require__)=>{var DESCRIPTORS=__webpack_require__(439),definePropertyModule=__webpack_require__(3271),createPropertyDescriptor=__webpack_require__(2898)
module.exports=DESCRIPTORS?function(object,key,value){return definePropertyModule.f(object,key,createPropertyDescriptor(1,value))}:function(object,key,value){return object[key]=value,object}},2898:module=>{module.exports=function(bitmap,value){return{enumerable:!(1&bitmap),configurable:!(2&bitmap),writable:!(4&bitmap),value}}},1186:(module,__unused_webpack_exports,__webpack_require__)=>{var isCallable=__webpack_require__(987),definePropertyModule=__webpack_require__(3271),makeBuiltIn=__webpack_require__(8131),defineGlobalProperty=__webpack_require__(861)
...
else{try{options.unsafe?O[key]&&(simple=!0):delete O[key]}catch(error){}simple?O[key]=value:definePropertyModule.f(O,key,{value,enumerable:!1,configurable:!options.nonConfigurable,writable:!options.nonWritable})}return O}},861:(module,__unused_webpack_exports,__webpack_require__)=>{var global=__webpack_require__(3865),defineProperty=Object.defineProperty
module.exports=function(key,value){try{defineProperty(global,key,{value,configurable:!0,writable:!0})}catch(error){global[key]=value}return value}},439:(module,__unused_webpack_exports,__webpack_require__)=>{var fails=__webpack_require__(6926)
module.exports=!fails((function(){return 7!=Object.defineProperty({},1,{get:function(){return 7}})[1]}))},2168:(module,__unused_webpack_exports,__webpack_require__)=>{var global=__webpack_require__(3865),isObject=__webpack_require__(2948),document=global.document,EXISTS=isObject(document)&&isObject(document.createElement)
module.exports=function(it){return EXISTS?document.createElement(it):{}}},4504:(module,__unused_webpack_exports,__webpack_require__)=>{var getBuiltIn=__webpack_require__(3272)
module.exports=getBuiltIn("navigator","userAgent")||""},2338:(module,__unused_webpack_exports,__webpack_require__)=>{var match,version,global=__webpack_require__(3865),userAgent=__webpack_require__(4504),process=global.process,Deno=global.Deno,versions=process&&process.versions||Deno&&Deno.version,v8=versions&&versions.v8
v8&&(version=(match=v8.split("."))[0]>0&&match[0]<4?1:+(match[0]+match[1])),!version&&userAgent&&(!(match=userAgent.match(/Edge\/(\d+)/))||match[1]>=74)&&(match=userAgent.match(/Chrome\/(\d+)/))&&(version=+match[1]),module.exports=version},3392:module=>{module.exports=["constructor","hasOwnProperty","isPrototypeOf","propertyIsEnumerable","toLocaleString","toString","valueOf"]},2589:(module,__unused_webpack_exports,__webpack_require__)=>{var global=__webpack_require__(3865),getOwnPropertyDescriptor=__webpack_require__(2024).f,createNonEnumerableProperty=__webpack_require__(1057),defineBuiltIn=__webpack_require__(1186),defineGlobalProperty=__webpack_require__(861),copyConstructorProperties=__webpack_require__(6537),isForced=__webpack_require__(1090)
...
copyConstructorProperties(sourceProperty,targetProperty)}(options.sham||targetProperty&&targetProperty.sham)&&createNonEnumerableProperty(sourceProperty,"sham",!0),defineBuiltIn(target,key,sourceProperty,options)}}},6926:module=>{module.exports=function(exec){try{return!!exec()}catch(error){return!0}}},3097:(module,__unused_webpack_exports,__webpack_require__)=>{var uncurryThis=__webpack_require__(335),aCallable=__webpack_require__(5474),NATIVE_BIND=__webpack_require__(4347),bind=uncurryThis(uncurryThis.bind)
module.exports=function(fn,that){return aCallable(fn),void 0===that?fn:NATIVE_BIND?bind(fn,that):function(){return fn.apply(that,arguments)}}},4347:(module,__unused_webpack_exports,__webpack_require__)=>{var fails=__webpack_require__(6926)
module.exports=!fails((function(){var test=function(){}.bind()
return"function"!=typeof test||test.hasOwnProperty("prototype")}))},4041:(module,__unused_webpack_exports,__webpack_require__)=>{var NATIVE_BIND=__webpack_require__(4347),call=Function.prototype.call
module.exports=NATIVE_BIND?call.bind(call):function(){return call.apply(call,arguments)}},7477:(module,__unused_webpack_exports,__webpack_require__)=>{var DESCRIPTORS=__webpack_require__(439),hasOwn=__webpack_require__(7902),FunctionPrototype=Function.prototype,getDescriptor=DESCRIPTORS&&Object.getOwnPropertyDescriptor,EXISTS=hasOwn(FunctionPrototype,"name"),PROPER=EXISTS&&"something"===function(){}.name,CONFIGURABLE=EXISTS&&(!DESCRIPTORS||DESCRIPTORS&&getDescriptor(FunctionPrototype,"name").configurable)
module.exports={EXISTS,PROPER,CONFIGURABLE}},335:(module,__unused_webpack_exports,__webpack_require__)=>{var NATIVE_BIND=__webpack_require__(4347),FunctionPrototype=Function.prototype,bind=FunctionPrototype.bind,call=FunctionPrototype.call,uncurryThis=NATIVE_BIND&&bind.bind(call,call)
module.exports=NATIVE_BIND?function(fn){return fn&&uncurryThis(fn)}:function(fn){return fn&&function(){return call.apply(fn,arguments)}}},3272:(module,__unused_webpack_exports,__webpack_require__)=>{var global=__webpack_require__(3865),isCallable=__webpack_require__(987),aFunction=function(argument){return isCallable(argument)?argument:void 0}
module.exports=function(namespace,method){return arguments.length<2?aFunction(global[namespace]):global[namespace]&&global[namespace][method]}},1038:(module,__unused_webpack_exports,__webpack_require__)=>{var classof=__webpack_require__(157),getMethod=__webpack_require__(4351),Iterators=__webpack_require__(6282),ITERATOR=__webpack_require__(4729)("iterator")
module.exports=function(it){if(null!=it)return getMethod(it,ITERATOR)||getMethod(it,"@@iterator")||Iterators[classof(it)]}},5495:(module,__unused_webpack_exports,__webpack_require__)=>{var call=__webpack_require__(4041),aCallable=__webpack_require__(5474),anObject=__webpack_require__(9072),tryToString=__webpack_require__(5320),getIteratorMethod=__webpack_require__(1038),$TypeError=TypeError
...
throw $TypeError(tryToString(argument)+" is not iterable")}},9748:(module,__unused_webpack_exports,__webpack_require__)=>{var call=__webpack_require__(4041)
module.exports=function(it){return call(Map.prototype.entries,it)}},4351:(module,__unused_webpack_exports,__webpack_require__)=>{var aCallable=__webpack_require__(5474)
module.exports=function(V,P){var func=V[P]
return null==func?void 0:aCallable(func)}},8915:(module,__unused_webpack_exports,__webpack_require__)=>{var call=__webpack_require__(4041)
module.exports=function(it){return call(Set.prototype.values,it)}},3865:module=>{var check=function(it){return it&&it.Math==Math&&it}
module.exports=check("object"==typeof globalThis&&globalThis)||check("object"==typeof window&&window)||check("object"==typeof self&&self)||check("object"==typeof global&&global)||function(){return this}()||Function("return this")()},7902:(module,__unused_webpack_exports,__webpack_require__)=>{var uncurryThis=__webpack_require__(335),toObject=__webpack_require__(8008),hasOwnProperty=uncurryThis({}.hasOwnProperty)
module.exports=Object.hasOwn||function(it,key){return hasOwnProperty(toObject(it),key)}},27:module=>{module.exports={}},3176:(module,__unused_webpack_exports,__webpack_require__)=>{var DESCRIPTORS=__webpack_require__(439),fails=__webpack_require__(6926),createElement=__webpack_require__(2168)
module.exports=!DESCRIPTORS&&!fails((function(){return 7!=Object.defineProperty(createElement("div"),"a",{get:function(){return 7}}).a}))},2720:(module,__unused_webpack_exports,__webpack_require__)=>{var uncurryThis=__webpack_require__(335),fails=__webpack_require__(6926),classof=__webpack_require__(3224),$Object=Object,split=uncurryThis("".split)
module.exports=fails((function(){return!$Object("z").propertyIsEnumerable(0)}))?function(it){return"String"==classof(it)?split(it,""):$Object(it)}:$Object},445:(module,__unused_webpack_exports,__webpack_require__)=>{var uncurryThis=__webpack_require__(335),isCallable=__webpack_require__(987),store=__webpack_require__(3339),functionToString=uncurryThis(Function.toString)
isCallable(store.inspectSource)||(store.inspectSource=function(it){return functionToString(it)}),module.exports=store.inspectSource},2590:(module,__unused_webpack_exports,__webpack_require__)=>{var set,get,has,NATIVE_WEAK_MAP=__webpack_require__(83),global=__webpack_require__(3865),uncurryThis=__webpack_require__(335),isObject=__webpack_require__(2948),createNonEnumerableProperty=__webpack_require__(1057),hasOwn=__webpack_require__(7902),shared=__webpack_require__(3339),sharedKey=__webpack_require__(4749),hiddenKeys=__webpack_require__(27),TypeError=global.TypeError,WeakMap=global.WeakMap
...
return state}}}},1315:(module,__unused_webpack_exports,__webpack_require__)=>{var wellKnownSymbol=__webpack_require__(4729),Iterators=__webpack_require__(6282),ITERATOR=wellKnownSymbol("iterator"),ArrayPrototype=Array.prototype
module.exports=function(it){return void 0!==it&&(Iterators.Array===it||ArrayPrototype[ITERATOR]===it)}},987:module=>{module.exports=function(argument){return"function"==typeof argument}},6486:(module,__unused_webpack_exports,__webpack_require__)=>{var uncurryThis=__webpack_require__(335),fails=__webpack_require__(6926),isCallable=__webpack_require__(987),classof=__webpack_require__(157),getBuiltIn=__webpack_require__(3272),inspectSource=__webpack_require__(445),noop=function(){},empty=[],construct=getBuiltIn("Reflect","construct"),constructorRegExp=/^\s*(?:class|function)\b/,exec=uncurryThis(constructorRegExp.exec),INCORRECT_TO_STRING=!constructorRegExp.exec(noop),isConstructorModern=function(argument){if(!isCallable(argument))return!1
...
return isConstructorModern(isConstructorModern.call)||!isConstructorModern(Object)||!isConstructorModern((function(){called=!0}))||called}))?isConstructorLegacy:isConstructorModern},1090:(module,__unused_webpack_exports,__webpack_require__)=>{var fails=__webpack_require__(6926),isCallable=__webpack_require__(987),replacement=/#|\.prototype\./,isForced=function(feature,detection){var value=data[normalize(feature)]
...
module.exports=isForced},2948:(module,__unused_webpack_exports,__webpack_require__)=>{var isCallable=__webpack_require__(987)
module.exports=function(it){return"object"==typeof it?null!==it:isCallable(it)}},898:module=>{module.exports=!1},5079:(module,__unused_webpack_exports,__webpack_require__)=>{var getBuiltIn=__webpack_require__(3272),isCallable=__webpack_require__(987),isPrototypeOf=__webpack_require__(6706),USE_SYMBOL_AS_UID=__webpack_require__(914),$Object=Object
module.exports=USE_SYMBOL_AS_UID?function(it){return"symbol"==typeof it}:function(it){var $Symbol=getBuiltIn("Symbol")
return isCallable($Symbol)&&isPrototypeOf($Symbol.prototype,$Object(it))}},8737:(module,__unused_webpack_exports,__webpack_require__)=>{var bind=__webpack_require__(3097),call=__webpack_require__(4041),anObject=__webpack_require__(9072),tryToString=__webpack_require__(5320),isArrayIteratorMethod=__webpack_require__(1315),lengthOfArrayLike=__webpack_require__(5008),isPrototypeOf=__webpack_require__(6706),getIterator=__webpack_require__(5495),getIteratorMethod=__webpack_require__(1038),iteratorClose=__webpack_require__(9792),$TypeError=TypeError,Result=function(stopped,result){this.stopped=stopped,this.result=result},ResultPrototype=Result.prototype
module.exports=function(iterable,unboundFunction,options){var iterator,iterFn,index,length,result,next,step,that=options&&options.that,AS_ENTRIES=!(!options||!options.AS_ENTRIES),IS_ITERATOR=!(!options||!options.IS_ITERATOR),INTERRUPTED=!(!options||!options.INTERRUPTED),fn=bind(unboundFunction,that),stop=function(condition){return iterator&&iteratorClose(iterator,"normal",condition),new Result(!0,condition)},callFn=function(value){return AS_ENTRIES?(anObject(value),INTERRUPTED?fn(value[0],value[1],stop):fn(value[0],value[1])):INTERRUPTED?fn(value,stop):fn(value)}
...
return new Result(!1)}iterator=getIterator(iterable,iterFn)}for(next=iterator.next;!(step=call(next,iterator)).done;){try{result=callFn(step.value)}catch(error){iteratorClose(iterator,"throw",error)}if("object"==typeof result&&result&&isPrototypeOf(ResultPrototype,result))return result}return new Result(!1)}},9792:(module,__unused_webpack_exports,__webpack_require__)=>{var call=__webpack_require__(4041),anObject=__webpack_require__(9072),getMethod=__webpack_require__(4351)
...
return anObject(innerResult),value}},6282:module=>{module.exports={}},5008:(module,__unused_webpack_exports,__webpack_require__)=>{var toLength=__webpack_require__(3524)
module.exports=function(obj){return toLength(obj.length)}},8131:(module,__unused_webpack_exports,__webpack_require__)=>{var fails=__webpack_require__(6926),isCallable=__webpack_require__(987),hasOwn=__webpack_require__(7902),DESCRIPTORS=__webpack_require__(439),CONFIGURABLE_FUNCTION_NAME=__webpack_require__(7477).CONFIGURABLE,inspectSource=__webpack_require__(445),InternalStateModule=__webpack_require__(2590),enforceInternalState=InternalStateModule.enforce,getInternalState=InternalStateModule.get,defineProperty=Object.defineProperty,CONFIGURABLE_LENGTH=DESCRIPTORS&&!fails((function(){return 8!==defineProperty((function(){}),"length",{value:8}).length})),TEMPLATE=String(String).split("String"),makeBuiltIn=module.exports=function(value,name,options){"Symbol("===String(name).slice(0,7)&&(name="["+String(name).replace(/^Symbol\(([^)]*)\)/,"$1")+"]"),options&&options.getter&&(name="get "+name),options&&options.setter&&(name="set "+name),(!hasOwn(value,"name")||CONFIGURABLE_FUNCTION_NAME&&value.name!==name)&&(DESCRIPTORS?defineProperty(value,"name",{value:name,configurable:!0}):value.name=name),CONFIGURABLE_LENGTH&&options&&hasOwn(options,"arity")&&value.length!==options.arity&&defineProperty(value,"length",{value:options.arity})
...
Function.prototype.toString=makeBuiltIn((function(){return isCallable(this)&&getInternalState(this).source||inspectSource(this)}),"toString")},8038:module=>{var ceil=Math.ceil,floor=Math.floor
module.exports=Math.trunc||function(x){var n=+x
return(n>0?floor:ceil)(n)}},680:(module,__unused_webpack_exports,__webpack_require__)=>{var V8_VERSION=__webpack_require__(2338),fails=__webpack_require__(6926)
module.exports=!!Object.getOwnPropertySymbols&&!fails((function(){var symbol=Symbol()
return!String(symbol)||!(Object(symbol)instanceof Symbol)||!Symbol.sham&&V8_VERSION&&V8_VERSION<41}))},83:(module,__unused_webpack_exports,__webpack_require__)=>{var global=__webpack_require__(3865),isCallable=__webpack_require__(987),inspectSource=__webpack_require__(445),WeakMap=global.WeakMap
module.exports=isCallable(WeakMap)&&/native code/.test(inspectSource(WeakMap))},3271:(__unused_webpack_module,exports,__webpack_require__)=>{var DESCRIPTORS=__webpack_require__(439),IE8_DOM_DEFINE=__webpack_require__(3176),V8_PROTOTYPE_DEFINE_BUG=__webpack_require__(7351),anObject=__webpack_require__(9072),toPropertyKey=__webpack_require__(1572),$TypeError=TypeError,$defineProperty=Object.defineProperty,$getOwnPropertyDescriptor=Object.getOwnPropertyDescriptor
...
return"value"in Attributes&&(O[P]=Attributes.value),O}},2024:(__unused_webpack_module,exports,__webpack_require__)=>{var DESCRIPTORS=__webpack_require__(439),call=__webpack_require__(4041),propertyIsEnumerableModule=__webpack_require__(263),createPropertyDescriptor=__webpack_require__(2898),toIndexedObject=__webpack_require__(3521),toPropertyKey=__webpack_require__(1572),hasOwn=__webpack_require__(7902),IE8_DOM_DEFINE=__webpack_require__(3176),$getOwnPropertyDescriptor=Object.getOwnPropertyDescriptor
exports.f=DESCRIPTORS?$getOwnPropertyDescriptor:function(O,P){if(O=toIndexedObject(O),P=toPropertyKey(P),IE8_DOM_DEFINE)try{return $getOwnPropertyDescriptor(O,P)}catch(error){}if(hasOwn(O,P))return createPropertyDescriptor(!call(propertyIsEnumerableModule.f,O,P),O[P])}},274:(__unused_webpack_module,exports,__webpack_require__)=>{var internalObjectKeys=__webpack_require__(6499),hiddenKeys=__webpack_require__(3392).concat("length","prototype")
exports.f=Object.getOwnPropertyNames||function(O){return internalObjectKeys(O,hiddenKeys)}},3694:(__unused_webpack_module,exports)=>{exports.f=Object.getOwnPropertySymbols},6706:(module,__unused_webpack_exports,__webpack_require__)=>{var uncurryThis=__webpack_require__(335)
module.exports=uncurryThis({}.isPrototypeOf)},6499:(module,__unused_webpack_exports,__webpack_require__)=>{var uncurryThis=__webpack_require__(335),hasOwn=__webpack_require__(7902),toIndexedObject=__webpack_require__(3521),indexOf=__webpack_require__(9502).indexOf,hiddenKeys=__webpack_require__(27),push=uncurryThis([].push)
...
return result}},263:(__unused_webpack_module,exports)=>{"use strict"
...
return!!descriptor&&descriptor.enumerable}:$propertyIsEnumerable},336:(module,__unused_webpack_exports,__webpack_require__)=>{var call=__webpack_require__(4041),isCallable=__webpack_require__(987),isObject=__webpack_require__(2948),$TypeError=TypeError
...
if("string"!==pref&&isCallable(fn=input.toString)&&!isObject(val=call(fn,input)))return val
throw $TypeError("Can't convert object to primitive value")}},3475:(module,__unused_webpack_exports,__webpack_require__)=>{var getBuiltIn=__webpack_require__(3272),uncurryThis=__webpack_require__(335),getOwnPropertyNamesModule=__webpack_require__(274),getOwnPropertySymbolsModule=__webpack_require__(3694),anObject=__webpack_require__(9072),concat=uncurryThis([].concat)
...
return getOwnPropertySymbols?concat(keys,getOwnPropertySymbols(it)):keys}},5460:module=>{var $TypeError=TypeError
module.exports=function(it){if(null==it)throw $TypeError("Can't call method on "+it)
return it}},1376:module=>{module.exports=function(x,y){return x===y||x!=x&&y!=y}},4749:(module,__unused_webpack_exports,__webpack_require__)=>{var shared=__webpack_require__(9421),uid=__webpack_require__(1962),keys=shared("keys")
module.exports=function(key){return keys[key]||(keys[key]=uid(key))}},3339:(module,__unused_webpack_exports,__webpack_require__)=>{var global=__webpack_require__(3865),defineGlobalProperty=__webpack_require__(861),store=global["__core-js_shared__"]||defineGlobalProperty("__core-js_shared__",{})
module.exports=store},9421:(module,__unused_webpack_exports,__webpack_require__)=>{var IS_PURE=__webpack_require__(898),store=__webpack_require__(3339);(module.exports=function(key,value){return store[key]||(store[key]=void 0!==value?value:{})})("versions",[]).push({version:"3.23.3",mode:IS_PURE?"pure":"global",copyright:"© 2014-2022 Denis Pushkarev (zloirock.ru)",license:"https://github.com/zloirock/core-js/blob/v3.23.3/LICENSE",source:"https://github.com/zloirock/core-js"})},472:(module,__unused_webpack_exports,__webpack_require__)=>{var anObject=__webpack_require__(9072),aConstructor=__webpack_require__(943),SPECIES=__webpack_require__(4729)("species")
module.exports=function(O,defaultConstructor){var S,C=anObject(O).constructor
return void 0===C||null==(S=anObject(C)[SPECIES])?defaultConstructor:aConstructor(S)}},8876:(module,__unused_webpack_exports,__webpack_require__)=>{var toIntegerOrInfinity=__webpack_require__(337),max=Math.max,min=Math.min
module.exports=function(index,length){var integer=toIntegerOrInfinity(index)
return integer<0?max(integer+length,0):min(integer,length)}},3521:(module,__unused_webpack_exports,__webpack_require__)=>{var IndexedObject=__webpack_require__(2720),requireObjectCoercible=__webpack_require__(5460)
module.exports=function(it){return IndexedObject(requireObjectCoercible(it))}},337:(module,__unused_webpack_exports,__webpack_require__)=>{var trunc=__webpack_require__(8038)
module.exports=function(argument){var number=+argument
return number!=number||0===number?0:trunc(number)}},3524:(module,__unused_webpack_exports,__webpack_require__)=>{var toIntegerOrInfinity=__webpack_require__(337),min=Math.min
module.exports=function(argument){return argument>0?min(toIntegerOrInfinity(argument),9007199254740991):0}},8008:(module,__unused_webpack_exports,__webpack_require__)=>{var requireObjectCoercible=__webpack_require__(5460),$Object=Object
module.exports=function(argument){return $Object(requireObjectCoercible(argument))}},1610:(module,__unused_webpack_exports,__webpack_require__)=>{var call=__webpack_require__(4041),isObject=__webpack_require__(2948),isSymbol=__webpack_require__(5079),getMethod=__webpack_require__(4351),ordinaryToPrimitive=__webpack_require__(336),wellKnownSymbol=__webpack_require__(4729),$TypeError=TypeError,TO_PRIMITIVE=wellKnownSymbol("toPrimitive")
...
throw $TypeError("Can't convert object to primitive value")}return void 0===pref&&(pref="number"),ordinaryToPrimitive(input,pref)}},1572:(module,__unused_webpack_exports,__webpack_require__)=>{var toPrimitive=__webpack_require__(1610),isSymbol=__webpack_require__(5079)
module.exports=function(argument){var key=toPrimitive(argument,"string")
return isSymbol(key)?key:key+""}},5149:(module,__unused_webpack_exports,__webpack_require__)=>{var test={}
test[__webpack_require__(4729)("toStringTag")]="z",module.exports="[object z]"===String(test)},4013:(module,__unused_webpack_exports,__webpack_require__)=>{var classof=__webpack_require__(157),$String=String
module.exports=function(argument){if("Symbol"===classof(argument))throw TypeError("Cannot convert a Symbol value to a string")
return $String(argument)}},5320:module=>{var $String=String
module.exports=function(argument){try{return $String(argument)}catch(error){return"Object"}}},1962:(module,__unused_webpack_exports,__webpack_require__)=>{var uncurryThis=__webpack_require__(335),id=0,postfix=Math.random(),toString=uncurryThis(1..toString)
module.exports=function(key){return"Symbol("+(void 0===key?"":key)+")_"+toString(++id+postfix,36)}},914:(module,__unused_webpack_exports,__webpack_require__)=>{var NATIVE_SYMBOL=__webpack_require__(680)
module.exports=NATIVE_SYMBOL&&!Symbol.sham&&"symbol"==typeof Symbol.iterator},7351:(module,__unused_webpack_exports,__webpack_require__)=>{var DESCRIPTORS=__webpack_require__(439),fails=__webpack_require__(6926)
module.exports=DESCRIPTORS&&fails((function(){return 42!=Object.defineProperty((function(){}),"prototype",{value:42,writable:!1}).prototype}))},4729:(module,__unused_webpack_exports,__webpack_require__)=>{var global=__webpack_require__(3865),shared=__webpack_require__(9421),hasOwn=__webpack_require__(7902),uid=__webpack_require__(1962),NATIVE_SYMBOL=__webpack_require__(680),USE_SYMBOL_AS_UID=__webpack_require__(914),WellKnownSymbolsStore=shared("wks"),Symbol=global.Symbol,symbolFor=Symbol&&Symbol.for,createWellKnownSymbol=USE_SYMBOL_AS_UID?Symbol:Symbol&&Symbol.withoutSetter||uid
...
NATIVE_SYMBOL&&hasOwn(Symbol,name)?WellKnownSymbolsStore[name]=Symbol[name]:WellKnownSymbolsStore[name]=USE_SYMBOL_AS_UID&&symbolFor?symbolFor(description):createWellKnownSymbol(description)}return WellKnownSymbolsStore[name]}},7169:(__unused_webpack_module,__unused_webpack_exports,__webpack_require__)=>{"use strict"
__webpack_require__(2589)({target:"Map",proto:!0,real:!0,forced:!0},{deleteAll:__webpack_require__(1105)})},2166:(__unused_webpack_module,__unused_webpack_exports,__webpack_require__)=>{"use strict"
var $=__webpack_require__(2589),anObject=__webpack_require__(9072),bind=__webpack_require__(3097),getMapIterator=__webpack_require__(9748),iterate=__webpack_require__(8737)
...
return!iterate(iterator,(function(key,value,stop){if(!boundFunction(value,key,map))return stop()}),{AS_ENTRIES:!0,IS_ITERATOR:!0,INTERRUPTED:!0}).stopped}})},7047:(__unused_webpack_module,__unused_webpack_exports,__webpack_require__)=>{"use strict"
var $=__webpack_require__(2589),getBuiltIn=__webpack_require__(3272),bind=__webpack_require__(3097),call=__webpack_require__(4041),aCallable=__webpack_require__(5474),anObject=__webpack_require__(9072),speciesConstructor=__webpack_require__(472),getMapIterator=__webpack_require__(9748),iterate=__webpack_require__(8737)
...
return iterate(iterator,(function(key,value){boundFunction(value,key,map)&&call(setter,newMap,key,value)}),{AS_ENTRIES:!0,IS_ITERATOR:!0}),newMap}})},5072:(__unused_webpack_module,__unused_webpack_exports,__webpack_require__)=>{"use strict"
var $=__webpack_require__(2589),anObject=__webpack_require__(9072),bind=__webpack_require__(3097),getMapIterator=__webpack_require__(9748),iterate=__webpack_require__(8737)
...
return iterate(iterator,(function(key,value,stop){if(boundFunction(value,key,map))return stop(key)}),{AS_ENTRIES:!0,IS_ITERATOR:!0,INTERRUPTED:!0}).result}})},2850:(__unused_webpack_module,__unused_webpack_exports,__webpack_require__)=>{"use strict"
var $=__webpack_require__(2589),anObject=__webpack_require__(9072),bind=__webpack_require__(3097),getMapIterator=__webpack_require__(9748),iterate=__webpack_require__(8737)
...
return iterate(iterator,(function(key,value,stop){if(boundFunction(value,key,map))return stop(value)}),{AS_ENTRIES:!0,IS_ITERATOR:!0,INTERRUPTED:!0}).result}})},1070:(__unused_webpack_module,__unused_webpack_exports,__webpack_require__)=>{"use strict"
var $=__webpack_require__(2589),anObject=__webpack_require__(9072),getMapIterator=__webpack_require__(9748),sameValueZero=__webpack_require__(1376),iterate=__webpack_require__(8737)
$({target:"Map",proto:!0,real:!0,forced:!0},{includes:function(searchElement){return iterate(getMapIterator(anObject(this)),(function(key,value,stop){if(sameValueZero(value,searchElement))return stop()}),{AS_ENTRIES:!0,IS_ITERATOR:!0,INTERRUPTED:!0}).stopped}})},9224:(__unused_webpack_module,__unused_webpack_exports,__webpack_require__)=>{"use strict"
var $=__webpack_require__(2589),anObject=__webpack_require__(9072),getMapIterator=__webpack_require__(9748),iterate=__webpack_require__(8737)
$({target:"Map",proto:!0,real:!0,forced:!0},{keyOf:function(searchElement){return iterate(getMapIterator(anObject(this)),(function(key,value,stop){if(value===searchElement)return stop(key)}),{AS_ENTRIES:!0,IS_ITERATOR:!0,INTERRUPTED:!0}).result}})},7875:(__unused_webpack_module,__unused_webpack_exports,__webpack_require__)=>{"use strict"
var $=__webpack_require__(2589),getBuiltIn=__webpack_require__(3272),bind=__webpack_require__(3097),call=__webpack_require__(4041),aCallable=__webpack_require__(5474),anObject=__webpack_require__(9072),speciesConstructor=__webpack_require__(472),getMapIterator=__webpack_require__(9748),iterate=__webpack_require__(8737)
...
return iterate(iterator,(function(key,value){call(setter,newMap,boundFunction(value,key,map),value)}),{AS_ENTRIES:!0,IS_ITERATOR:!0}),newMap}})},1615:(__unused_webpack_module,__unused_webpack_exports,__webpack_require__)=>{"use strict"
var $=__webpack_require__(2589),getBuiltIn=__webpack_require__(3272),bind=__webpack_require__(3097),call=__webpack_require__(4041),aCallable=__webpack_require__(5474),anObject=__webpack_require__(9072),speciesConstructor=__webpack_require__(472),getMapIterator=__webpack_require__(9748),iterate=__webpack_require__(8737)
...
return iterate(iterator,(function(key,value){call(setter,newMap,key,boundFunction(value,key,map))}),{AS_ENTRIES:!0,IS_ITERATOR:!0}),newMap}})},6438:(__unused_webpack_module,__unused_webpack_exports,__webpack_require__)=>{"use strict"
var $=__webpack_require__(2589),aCallable=__webpack_require__(5474),anObject=__webpack_require__(9072),iterate=__webpack_require__(8737)
...
return map}})},8691:(__unused_webpack_module,__unused_webpack_exports,__webpack_require__)=>{"use strict"
var $=__webpack_require__(2589),anObject=__webpack_require__(9072),aCallable=__webpack_require__(5474),getMapIterator=__webpack_require__(9748),iterate=__webpack_require__(8737),$TypeError=TypeError
...
return accumulator}})},1959:(__unused_webpack_module,__unused_webpack_exports,__webpack_require__)=>{"use strict"
var $=__webpack_require__(2589),anObject=__webpack_require__(9072),bind=__webpack_require__(3097),getMapIterator=__webpack_require__(9748),iterate=__webpack_require__(8737)
...
return iterate(iterator,(function(key,value,stop){if(boundFunction(value,key,map))return stop()}),{AS_ENTRIES:!0,IS_ITERATOR:!0,INTERRUPTED:!0}).stopped}})},9025:(__unused_webpack_module,__unused_webpack_exports,__webpack_require__)=>{"use strict"
var $=__webpack_require__(2589),call=__webpack_require__(4041),anObject=__webpack_require__(9072),aCallable=__webpack_require__(5474),$TypeError=TypeError
...
return call(set,map,key,callback(value,key,map)),map}})},8877:(__unused_webpack_module,__unused_webpack_exports,__webpack_require__)=>{"use strict"
__webpack_require__(2589)({target:"Set",proto:!0,real:!0,forced:!0},{addAll:__webpack_require__(4973)})},4703:(__unused_webpack_module,__unused_webpack_exports,__webpack_require__)=>{"use strict"
__webpack_require__(2589)({target:"Set",proto:!0,real:!0,forced:!0},{deleteAll:__webpack_require__(1105)})},8023:(__unused_webpack_module,__unused_webpack_exports,__webpack_require__)=>{"use strict"
var $=__webpack_require__(2589),getBuiltIn=__webpack_require__(3272),call=__webpack_require__(4041),aCallable=__webpack_require__(5474),anObject=__webpack_require__(9072),speciesConstructor=__webpack_require__(472),iterate=__webpack_require__(8737)
...
return iterate(iterable,(function(value){call(remover,newSet,value)})),newSet}})},1839:(__unused_webpack_module,__unused_webpack_exports,__webpack_require__)=>{"use strict"
var $=__webpack_require__(2589),anObject=__webpack_require__(9072),bind=__webpack_require__(3097),getSetIterator=__webpack_require__(8915),iterate=__webpack_require__(8737)
...
return!iterate(iterator,(function(value,stop){if(!boundFunction(value,value,set))return stop()}),{IS_ITERATOR:!0,INTERRUPTED:!0}).stopped}})},2858:(__unused_webpack_module,__unused_webpack_exports,__webpack_require__)=>{"use strict"
var $=__webpack_require__(2589),getBuiltIn=__webpack_require__(3272),call=__webpack_require__(4041),aCallable=__webpack_require__(5474),anObject=__webpack_require__(9072),bind=__webpack_require__(3097),speciesConstructor=__webpack_require__(472),getSetIterator=__webpack_require__(8915),iterate=__webpack_require__(8737)
...
return iterate(iterator,(function(value){boundFunction(value,value,set)&&call(adder,newSet,value)}),{IS_ITERATOR:!0}),newSet}})},7719:(__unused_webpack_module,__unused_webpack_exports,__webpack_require__)=>{"use strict"
var $=__webpack_require__(2589),anObject=__webpack_require__(9072),bind=__webpack_require__(3097),getSetIterator=__webpack_require__(8915),iterate=__webpack_require__(8737)
...
return iterate(iterator,(function(value,stop){if(boundFunction(value,value,set))return stop(value)}),{IS_ITERATOR:!0,INTERRUPTED:!0}).result}})},6352:(__unused_webpack_module,__unused_webpack_exports,__webpack_require__)=>{"use strict"
var $=__webpack_require__(2589),getBuiltIn=__webpack_require__(3272),call=__webpack_require__(4041),aCallable=__webpack_require__(5474),anObject=__webpack_require__(9072),speciesConstructor=__webpack_require__(472),iterate=__webpack_require__(8737)
...
return iterate(iterable,(function(value){call(hasCheck,set,value)&&call(adder,newSet,value)})),newSet}})},1436:(__unused_webpack_module,__unused_webpack_exports,__webpack_require__)=>{"use strict"
var $=__webpack_require__(2589),call=__webpack_require__(4041),aCallable=__webpack_require__(5474),anObject=__webpack_require__(9072),iterate=__webpack_require__(8737)
$({target:"Set",proto:!0,real:!0,forced:!0},{isDisjointFrom:function(iterable){var set=anObject(this),hasCheck=aCallable(set.has)
return!iterate(iterable,(function(value,stop){if(!0===call(hasCheck,set,value))return stop()}),{INTERRUPTED:!0}).stopped}})},9517:(__unused_webpack_module,__unused_webpack_exports,__webpack_require__)=>{"use strict"
var $=__webpack_require__(2589),getBuiltIn=__webpack_require__(3272),call=__webpack_require__(4041),aCallable=__webpack_require__(5474),isCallable=__webpack_require__(987),anObject=__webpack_require__(9072),getIterator=__webpack_require__(5495),iterate=__webpack_require__(8737)
...
return isCallable(hasCheck)||(otherSet=new(getBuiltIn("Set"))(iterable),hasCheck=aCallable(otherSet.has)),!iterate(iterator,(function(value,stop){if(!1===call(hasCheck,otherSet,value))return stop()}),{IS_ITERATOR:!0,INTERRUPTED:!0}).stopped}})},7849:(__unused_webpack_module,__unused_webpack_exports,__webpack_require__)=>{"use strict"
var $=__webpack_require__(2589),call=__webpack_require__(4041),aCallable=__webpack_require__(5474),anObject=__webpack_require__(9072),iterate=__webpack_require__(8737)
$({target:"Set",proto:!0,real:!0,forced:!0},{isSupersetOf:function(iterable){var set=anObject(this),hasCheck=aCallable(set.has)
return!iterate(iterable,(function(value,stop){if(!1===call(hasCheck,set,value))return stop()}),{INTERRUPTED:!0}).stopped}})},8761:(__unused_webpack_module,__unused_webpack_exports,__webpack_require__)=>{"use strict"
var $=__webpack_require__(2589),uncurryThis=__webpack_require__(335),anObject=__webpack_require__(9072),toString=__webpack_require__(4013),getSetIterator=__webpack_require__(8915),iterate=__webpack_require__(8737),arrayJoin=uncurryThis([].join),push=[].push
...
return iterate(iterator,push,{that:result,IS_ITERATOR:!0}),arrayJoin(result,sep)}})},1492:(__unused_webpack_module,__unused_webpack_exports,__webpack_require__)=>{"use strict"
var $=__webpack_require__(2589),getBuiltIn=__webpack_require__(3272),bind=__webpack_require__(3097),call=__webpack_require__(4041),aCallable=__webpack_require__(5474),anObject=__webpack_require__(9072),speciesConstructor=__webpack_require__(472),getSetIterator=__webpack_require__(8915),iterate=__webpack_require__(8737)
...
return iterate(iterator,(function(value){call(adder,newSet,boundFunction(value,value,set))}),{IS_ITERATOR:!0}),newSet}})},9709:(__unused_webpack_module,__unused_webpack_exports,__webpack_require__)=>{"use strict"
var $=__webpack_require__(2589),aCallable=__webpack_require__(5474),anObject=__webpack_require__(9072),getSetIterator=__webpack_require__(8915),iterate=__webpack_require__(8737),$TypeError=TypeError
...
return accumulator}})},4025:(__unused_webpack_module,__unused_webpack_exports,__webpack_require__)=>{"use strict"
var $=__webpack_require__(2589),anObject=__webpack_require__(9072),bind=__webpack_require__(3097),getSetIterator=__webpack_require__(8915),iterate=__webpack_require__(8737)
...
return iterate(iterator,(function(value,stop){if(boundFunction(value,value,set))return stop()}),{IS_ITERATOR:!0,INTERRUPTED:!0}).stopped}})},2438:(__unused_webpack_module,__unused_webpack_exports,__webpack_require__)=>{"use strict"
var $=__webpack_require__(2589),getBuiltIn=__webpack_require__(3272),call=__webpack_require__(4041),aCallable=__webpack_require__(5474),anObject=__webpack_require__(9072),speciesConstructor=__webpack_require__(472),iterate=__webpack_require__(8737)
...
return iterate(iterable,(function(value){call(remover,newSet,value)||call(adder,newSet,value)})),newSet}})},6549:(__unused_webpack_module,__unused_webpack_exports,__webpack_require__)=>{"use strict"
var $=__webpack_require__(2589),getBuiltIn=__webpack_require__(3272),aCallable=__webpack_require__(5474),anObject=__webpack_require__(9072),speciesConstructor=__webpack_require__(472),iterate=__webpack_require__(8737)
...
module.exports=require("crypto")},2361:module=>{"use strict"
...
module.exports=require("https")},2037:module=>{"use strict"
...
const{getManagedCacheStorage,CacheStorageGroup}=__webpack_require__(9220),parse=__webpack_require__(7310).parse
__webpack_require__(2290).disable=!0
const router=__webpack_require__(1784).PROVIDERS,cs=getManagedCacheStorage("bridge")
cs.aliveDuration=9e5
const csgInstance=CacheStorageGroup.getInstance()
setInterval((()=>{csgInstance.cleanup()}),9e5),__webpack_require__(3685).createServer().listen(parseInt(process.argv[2])||9e3).on("request",((req,res)=>((url,router)=>Promise.resolve().then((()=>{const route=url.pathname.slice(1).split("/").map((path=>decodeURIComponent(path)))
let pointer=router,argument=decodeURIComponent(url.query)
try{argument=JSON.parse(argument)}catch(e){}return route.some((path=>{if(!(path in pointer))return!0
pointer=pointer[path]}))||"function"!=typeof pointer?Promise.reject():cs.cache(argument,(()=>pointer(argument)))})))(parse(req.url),router).then((data=>res.write(data))).catch((()=>res.writeHead(404))).then((()=>res.end()))))})()})()
